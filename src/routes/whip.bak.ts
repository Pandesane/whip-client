...
export class WHIPClientTS {
  ...
  async publish(pc: RTCPeerConnection, url: string, token: string) {
    ...
    console.log(fetched.body, fetched.headers)
    console.log(fetched.headers.values())
  ...
  async patch() {
    ...
    try {
      ...
      //   const remoteDescription: RTCSessionDescription = this.pc!.remoteDescription!;
