...
import { NameAddrHeader } from "./NameAddrHeader.ts";
...
class SyntaxError {
  constructor(expected, found, offset, line, column) {
...
export function parse(input, startRule) {
  var parseFunctions = {
    CRLF: parse_CRLF,
    DIGIT: parse_DIGIT,
    ALPHA: parse_ALPHA,
