 ...
 * Parse SIP Message
 */
export const parseMessage = (data: any, ua: any) => {
  let message;
  let bodyStart;
 ...
 */
function getHeader(data: any, headerStart: any) {
...
function parseHeader(message: any, data: any, headerStart: any, headerEnd: any) {
  let parsed;
